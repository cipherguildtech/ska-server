...
export declare class TasksService {
    ...
    acceptOrReject(task_id: string, action: string, phone: string, reason: string | null): Promise<{
        id: string;
        project_id: string;
    ...
    updateStatus(id: string, status: string, completed_at: string): Promise<"Task not available" | "Invalid status" | {
        description: string | null;
        id: string;
        created_at: Date;
        updated_at: Date;
    ...
    saveTaskFiles(id: string, files: string[]): Promise<{
        message: string;
    } | undefined>;
}
