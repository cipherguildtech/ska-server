    ...
    async updateUserDetails(phone, requestBody) {
        try {
            ...
            if (requestBody.name !== null)
                data.full_name = requestBody.name;
            if (requestBody.email !== null)
                data.email = requestBody.email;
            if (requestBody.password !== null)
                data.password_hash = await bcrypt.hash(requestBody.password, saltOrRounds);
            if (requestBody.role !== null)
                data.role = requestBody.role;
            if (requestBody.department !== null)
                data.department = requestBody.department;
