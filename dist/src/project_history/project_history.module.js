...
const project_history_controller_1 = require("./project_history.controller");
...
exports.ProjectHistoryModule = ProjectHistoryModule = __decorate([
    (0, common_1.Module)({
        controllers: [project_history_controller_1.ProjectHistoryController],
        providers: [project_history_service_1.ProjectHistoryService],
    })
], ProjectHistoryModule);
//# sourceMappingURL=project_history.module.js.map